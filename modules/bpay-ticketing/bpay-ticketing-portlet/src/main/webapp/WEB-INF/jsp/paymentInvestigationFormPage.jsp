<%@ include file="init.jsp" %>
	...
	<portlet:renderURL escapeXml="false" var="submitPaymentInvestigationFormActionUrl">
		<portlet:param name="render" value="paymentInvestigationFormAction" />
	</portlet:renderURL>

	<h1>BPay Payment Enquiry</h1>

	<form:form action="${submitPaymentInvestigationFormActionUrl}" id="paymentInvestigationForm" method="post" modelAttribute="serviceRequestForm">
		<fieldset>
		...
		<fieldset>
			...
			<div class="bpay-input-wrapper">
				<form:checkbox path="disclaimer" /><label for="disclaimer">I agree Cuscal is not liable for any errors and/or delays due to incorrect/incomplete information being supplied.</label>
...
</div> <%-- The start of this is in init.jsp --%>