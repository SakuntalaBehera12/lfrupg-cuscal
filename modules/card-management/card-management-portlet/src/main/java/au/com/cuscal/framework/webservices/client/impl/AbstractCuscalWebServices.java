...
public abstract class AbstractCuscalWebServices implements CuscalWebServices {
	...
	public static final String SCHEME_SERVICE_URL_KEY = "webservice.scheme.url";
	...
	public void loadProperties(String propertyFilename) throws IOException {
		...
		try {
			...
			this.ticketingServicesUrl = p.getProperty(
				"webservice.ticketing.url");
			this.schemeServicesUrl = p.getProperty("webservice.scheme.url");
			...
			logger.info(
				"Loaded webservice.scheme.url=" + this.schemeServicesUrl);
	...
	public void loadPropertiesEasyConf(String componentName)
		...
		this.ticketingServicesUrl = p.getString("webservice.ticketing.url");
		this.schemeServicesUrl = p.getString("webservice.scheme.url");
		...
		logger.info(
			"Loaded webservice.ticketing.url=" + this.ticketingServicesUrl);
		logger.info("Loaded webservice.scheme.url=" + this.schemeServicesUrl);
	...
	public void setSchemeServicesUrl(String schemeServicesUrl) {
		this.schemeServicesUrl = schemeServicesUrl;
	}
	...
	protected void initWebServicePools() {
		...
		this.webServicePool.setSchemeServicesUrl(this.schemeServicesUrl);
