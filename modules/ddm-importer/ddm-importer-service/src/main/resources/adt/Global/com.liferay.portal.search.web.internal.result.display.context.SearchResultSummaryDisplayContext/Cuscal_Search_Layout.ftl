...
<#if entry.className == "com.liferay.document.library.kernel.model.DLFileEntry">
	<#assign
		fileEntry = dLAppLocalService.getFileEntry(entry.getClassPK())
		downloadURL = dlUtil.getDownloadURL(fileEntry, fileEntry.getFileVersion(), themeDisplay, "")
	/>
