...
<div id="service-request-wrapper">
	<c:choose>
		<c:when test="${updateTicket}">
			<portlet:actionURL escapeXml="false" var="submitDeTraceFormActionUrl">
				<portlet:param name="action" value="updateDeTraceFormAction" />
			</portlet:actionURL>
		</c:when>
		<c:otherwise>
			<portlet:actionURL escapeXml="false" var="submitDeTraceFormActionUrl">
				<portlet:param name="action" value="deTraceFormAction" />
			</portlet:actionURL>
		</c:otherwise>
	</c:choose>

	<h1>Direct Entry Trace</h1>

	<form:form action="${submitDeTraceFormActionUrl}" enctype="multipart/form-data" id="deForm" method="post" modelAttribute="serviceRequestForm">
		...
		<fieldset>
			...
			<div class="de-input-wrapper">
				<form:label class="large" path="attributesInformation.requestFor">Request Type<em class="mandatory">*</em></form:label>
				<form:select id="requestFor" path="attributesInformation.requestFor">
					<option value="">Please select</option>

					<form:options items="${deListBoxData.requestForMap}" />
				</form:select>

				<a href="javascript:;" title="Request For"><strong>?</strong></a>

				<form:errors class="error" path="attributesInformation.requestFor" />
			</div>
		</fieldset>
		...
		<fieldset>
			...
			<div class="de-input-wrapper">
				<form:label class="large" path="attributesInformation.finInstName">Sending Financial Institution Name<em class="mandatory" id="finInstNameMandatory">*</em></form:label>
				<c:choose>
			...
			<div class="de-input-wrapper">
				<form:label class="large" path="attributesInformation.finInstUserId">Sending Financial Institution User ID<em class="mandatory" id="finInstUserIdMandatory">*</em></form:label>
				<c:choose>
					<c:when test="${prepopulated}">
			...
			<div class="de-input-wrapper">
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<div id="destinationBSBHoverText" style="display: inline;"><a href="javascript:;" title="This is your member/customers BSB number with your Institution"><strong>?</strong></a></div>
			...
			<div class="de-input-wrapper">
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<div id="destinationAccountNumberHoverText" style="display: inline;"><a href="javascript:;" title="This is your member/customers account number with your Institution"><strong>?</strong></a></div>
			...
			<div class="de-input-wrapper">
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<a href="javascript:;" title="This is the reference used by your member / customer when processing the transaction"><strong>?</strong></a>
		...
		<fieldset>
			...
			<div class="de-input-wrapper" id="remitterNameDiv">
