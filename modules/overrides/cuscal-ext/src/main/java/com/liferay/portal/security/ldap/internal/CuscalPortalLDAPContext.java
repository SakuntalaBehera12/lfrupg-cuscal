...
public class CuscalPortalLDAPContext extends DummyDirContext {

	public CuscalPortalLDAPContext(Attributes attributes) {
		_attributes = attributes;
	}

	public CuscalPortalLDAPContext(boolean ignoreCase) {
