...
import com.liferay.portlet.journal.asset.CuscalJournalArticleAssetRenderer;
import com.liferay.portlet.journal.util.CuscalJournalArticleUtil;
 ...
 * https://github.com/liferay/liferay-portal/blob/master/modules/apps/journal/journal-web/src/main/java/com/liferay/journal/web/internal/portlet/action/UpdateArticleMVCActionCommand.java
 *
 * @author Maurice Sepe
 */
@Component(
...
public class CuscalEditArticleAction extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		if ((body == null) || body.isEmpty()) {
			SessionErrors.add(
				actionRequest, "invalidApprovalNotes");
		...
		JournalArticle article = CuscalJournalArticleUtil.addOrUpdateArticle(
		...
		CuscalActionUtil.addCommentToWorkflow(
			actionRequest, article.getResourcePrimKey(),
	...
	private Map<String, String> _getFriendlyURLWarningMessages(
		...
		for (Map.Entry<Locale, String> entry :
			...
			if (!groupIds.isEmpty() &&
					((groupIds.size() > 1) ||
						!Objects.equals(
							groupIds.getFirst(), themeDisplay.getScopeGroupId()))) {
		...
		return HashMapBuilder.put(
				...
				() -> {
					...
					friendlyURLChangedMessages.addFirst(
						_language.get(
						httpServletRequest,
				...
				if (friendlyURLDuplicatedLocales.size() == 1) {
					return _language.format(
						...
						new String[] {
								_getLocaleDisplayNames(
									themeDisplay.getLocale(),
									friendlyURLDuplicatedLocales.getFirst())
						},
						false);
				}
		...
		if ((article != null) &&
			...
			if (Validator.isNotNull(redirect) &&
				...
				redirect = HttpComponentsUtil.addParameter(
					...
					CuscalJournalArticleAssetRenderer.getClassPK(article));
			}
		}
