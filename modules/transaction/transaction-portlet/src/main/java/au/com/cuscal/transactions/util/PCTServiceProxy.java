...
import au.com.cuscal.framework.webservices.client.impl.PCTServiceImpl;
...
public class PCTServiceProxy extends AbstractSelfRegisteringService
    implements PCTService {
    ...
    private final PCTServiceImpl pctService = new PCTServiceImpl();
