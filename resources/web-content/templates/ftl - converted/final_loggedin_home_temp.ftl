<#assign layoutService = serviceLocator.findService("com.liferay.portal.service.LayoutLocalService")><#assign nav_item = layoutService.getFriendlyURLLayout(getterUtil.getLong(request.theme-display.scope-group-id), false, "/online-applications")><div id="homeLoggedinContent">
									...
									<table id="loggedinHomeFeaturePadded">
										...
										<tr id="loggedinHomeFeatureContent">
											...
											<td rowspan="3" id="loggedinHomeFeatureImage">
												<#if stopPressImage1.getData() != "">												<img alt="" src="${stopPressImage1.getData()}" /></#if>
											</td>
										</tr>
										<tr>
											<td>
...
<div class="c8"> </div><div class="c7"> </div><div class="c6"> </div><div class="c5"> </div>
								...
								<td id="loggedinHomeFeatureSpacer">
									&nbsp;
								</td>
								<td id="loggedInTD">
<div class="c1"> </div><div class="c2"> </div><div class="c3"> </div><div class="c4"> </div>
<div id="loggedinHomeFeature">
									<table id="loggedinHomeFeaturePadded">
										...
										<tr id="loggedinHomeFeatureContent">
											...
											<td rowspan="3" id="loggedinHomeFeatureImage">
												<#if stopPressImage2.getData() != "">												<img alt="" src="${stopPressImage2.getData()}" /></#if>											</td>
										</tr>
										<tr>
											<td>
												<span style="font-size: x-small">&nbsp;</a>
...
<div id="newsContent">
	...
	<div style="width:717px; margin-left: 15px; overflow: hidden; height:210px;">
		...
		<div id="rightBar">
		<#foreach nav_app in nav_item.getChildren(permissionChecker)><#assign size = velocityCount></#foreach><#if (size>0)><div id="rightNav">
...
<a href="#" onClick="javascript:window.open('${nav_app.getFriendlyURL()}','newWindow','HEIGHT=600, WIDTH=800, TOP=0,resizable=1,scrollbars=1')"><span>${nav_app.getName()}</span></a>
